...
const paragraphs = [
  "Your customers are searching online right now and we make sure they find you first. As a results-driven digital marketing company, we create strategies that turn clicks into customers and visitors into loyal buyers. Shopskey offers SEO, PPC, social media, content marketing, and more, all designed to boost your visibility and accelerate your growth. We don't just focus on traffic, we focus on generating sales and measurable returns for your business. Whether you're launching a new brand or scaling an established one, our team is ready to help you grow starting today.",
];
const sectionItems = [
  {
...
const DigitalMarketing = () => {
  ...
  return (
    <>
      <LogoMagicSection
        headingText="Digital Marketing Services That Drive Growth"
        subheadingText="We are a digital marketing agency helping businesses increase visibility, attract customers, and grow revenue. From SEO to social media and paid ads, our strategies are built to get results."
        buttonText="Let's Grow My Brand"
        buttonAction={handleButtonClick}
        imageSrc="/images/Digital-Marketing-2.png"
        imageAlt="Logo Display"
        discountText="Get Upto 60% Discount"
        bgImage="/images/Digital-Marketing-1.png"
      />
      <LogoReviewSection
      ...
      />
      <BrandSection
        heading="Hire a Digital Marketing Company
and Start Growing Today"
        imageSrc="/images/Image-1-Digital-marketing.jpg"
        altText="All Logos"
      ...
      />
      <ThirdContentSection
        imageSrc="/images/logodesignimg2.png"
        items={sectionItems}
      />
      {/* <LogoDesignSection
      ...
      <PortfolioGrid
        header="Why Choose Us"
        subheader="Our Digital Marketing Portfolio: Campaigns That Turn Clicks Into Customers"
        description="Explore our impressive logo designs that show your brand’s essence. Our team of experts combines creativity with precision to deliver standout logos."
        images={[
          {
