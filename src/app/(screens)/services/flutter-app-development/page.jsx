...
const paragraphs = [
  "As a top-rated Flutter app development company, we specialize in delivering cutting-edge, cross-platform mobile applications that combine performance with stunning design. Our experienced developers leverage Flutter's powerful framework to create apps that run smoothly on both iOS and Android devices, reducing development time and cost without compromising quality.",

  "We focus on building scalable, secure, and user-friendly apps tailored to your business goals. Whether you're a startup or an established enterprise, our customer-centric approach ensures timely delivery and ongoing support. Partner with us to bring your app ideas to life and stay ahead in the competitive UK market.",
];
const sectionItems = [
  {
...
const FlutterAppDevelopment = () => {
  ...
  return (
    <>
      <LogoMagicSection
        headingText="Boost Your Business with Flutter App Development"
        subheadingText="Build beautiful, high-performance cross-platform apps with our dedicated Flutter app development team. We create seamless user experiences that work flawlessly on both iOS and Android devices."
        buttonText="Get Your Free Consultation"
        buttonAction={handleButtonClick}
        imageSrc="/images/Flutter-app-development-2.png"
        imageAlt="Logo Display"
        discountText="Get Upto 60% Discount"
        bgImage="/images/Flutter-app-development-1.png"
      />
      <LogoReviewSection
      ...
      />
      <BrandSection
        heading="Top-Rated Flutter App Development Company"
        imageSrc="/images/Image-1-flutter-app.jpg"
        altText="All Logos"
      ...
      />
      <ThirdContentSection
        imageSrc="/images/flutter-image.png"
        items={sectionItems}
      />
      {/* <LogoDesignSection
      ...
      <PortfolioGrid
        header="Why Choose Us"
        subheader="Our Flutter App Development Portfolio"
        description="Explore our impressive logo designs that show your brand’s essence. Our team of experts combines creativity with precision to deliver standout logos."
        images={[
          {
            src: "/images/flutterport1.webp",
            alt: "Portfolio 1",
          },
          {
            src: "/images/flutterport2.webp",
            alt: "Portfolio 2",
          },
          {
            src: "/images/flutterport3.webp",
            alt: "Portfolio 3",
          },
          {
            src: "/images/flutterport4.webp",
            alt: "Portfolio 4",
          },
          {
            src: "/images/flutterport5.webp",
            alt: "Portfolio 5",
          },
          {
            src: "/images/flutterport6.webp",
            alt: "Portfolio 6",
          },
          {
            src: "/images/flutterport7.webp",
            alt: "Portfolio 7",
          },
          {
            src: "/images/flutterport8.webp",
            alt: "Portfolio 8",
          },
          {
            src: "/images/flutterport9.webp",
            alt: "Portfolio 9",
          },
          {
            src: "/images/flutterport10.webp",
            alt: "Portfolio 10",
          },
        ]}
      />
