...
const paragraphs = [
  "Shopskey is a leading UK-based app development agency committed to delivering innovative, scalable, and secure mobile applications that align perfectly with your business goals. Whether you need an iOS, Android, or cross-platform solution, we ensure your app stands out and performs flawlessly in today's competitive market. Our end-to-end process covers everything from strategic planning and intuitive UI/UX design to robust coding and seamless launch. By combining advanced technology with a user-first approach, we build apps that are visually impressive and highly functional. Partner with Shopskey to turn your vision into a high-performing app that drives real business growth.",
];
const sectionItems = [
  {
...
const AppDevelopment = () => {
  ...
  return (
    <>
      <LogoMagicSection
        headingText="App Development Services Designed to Build Your Business"
      ...
      />
      <BrandSection
        heading="Hire an App Development Company
That Delivers Results"
        imageSrc="/images/Image-1-App-Development.jpg"
        altText="All Logos"
      ...
      <PortfolioGrid
        header="Why Choose Us"
        subheader="Our App Development Portfolio: Transforming Ideas into Powerful Mobile Solutions"
        description="Explore our impressive logo designs that show your brand’s essence. Our team of experts combines creativity with precision to deliver standout logos."
        images={[
          {
